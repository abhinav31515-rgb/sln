  ...
  <div class="container mx-auto px-6 max-w-[1280px]">
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1fr] gap-10 mb-12">
      <div class="flex flex-col gap-4">
        ...
        <p class="text-[var(--muted)] text-[14px] leading-[1.8] max-w-[280px]"><?php echo e($footerTagline); ?></p>
        <div class="flex gap-3">
          <a href="<?php echo e($socialInstagram); ?>" class="social-btn" aria-label="Instagram">📸</a>
          <a href="<?php echo e($socialTwitter); ?>" class="social-btn" aria-label="Twitter">🐦</a>
          <a href="<?php echo e($socialYoutube); ?>" class="social-btn" aria-label="YouTube">▶️</a>
          <a href="<?php echo e($socialLinkedin); ?>" class="social-btn" aria-label="LinkedIn">🔗</a>
        </div>
      </div>
    ...
    <div class="pt-6 border-t border-[var(--border)] flex flex-wrap justify-between items-center gap-4 text-[12px] text-[var(--muted)]">
      <span>© <?php echo e(date('Y')); ?> <?php echo e($brandName); ?> <?php echo e($copyrightSuffix); ?></span>
      <span>Crafted with intention in <?php echo e($city); ?></span>
    </div>
  </div>
</footer>
<?php /**PATH C:\Users\akm96\Downloads\New folder (5)\aurum\resources\views/components/footer.blade.php ENDPATH**/ ?>