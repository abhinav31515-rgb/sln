  ...
  <div class="container relative z-10 pt-[8rem] pb-[6rem]">
    <div class="max-w-[780px]">
      <div class="flex items-center gap-3 mb-6 reveal">
        ...
        <span class="text-[13px] tracking-[.15em] uppercase font-normal" style="color:var(--gold)"><?php echo e($identity?->get('tagline') ?? 'Luxury Unisex Salon'); ?></span>
      </div>
      ...
      <p class="text-[1.05rem] text-[var(--muted)] max-w-[480px] mb-10 leading-[1.8] reveal">
        <?php echo e($heroSubheadline); ?>

      </p>
      
      <div class="flex flex-wrap gap-4 mb-12 reveal">
        <button class="btn btn-primary" onclick="openBooking()"><?php echo e($heroCtaLabel); ?></button>
        <a href="#rituals" class="btn btn-outline">Explore Rituals</a>
      </div>
      
      <div class="flex flex-wrap gap-8 reveal">
        <div>
          <div class="font-serif text-[2rem] font-light text-[var(--gold)]"><?php echo e($stat1Value); ?></div>
          <div class="text-[11px] tracking-[.12em] uppercase text-[var(--muted)] mt-1"><?php echo e($stat1Label); ?></div>
        </div>
        <div>
          <div class="font-serif text-[2rem] font-light text-[var(--gold)]"><?php echo e($stat2Value); ?></div>
          <div class="text-[11px] tracking-[.12em] uppercase text-[var(--muted)] mt-1"><?php echo e($stat2Label); ?></div>
        </div>
        <div>
          <div class="font-serif text-[2rem] font-light text-[var(--gold)]"><?php echo e($stat3Value); ?></div>
          <div class="text-[11px] tracking-[.12em] uppercase text-[var(--muted)] mt-1"><?php echo e($stat3Label); ?></div>
        </div>
        <div>
          <div class="font-serif text-[2rem] font-light text-[var(--gold)]"><?php echo e($stat4Value); ?></div>
          <div class="text-[11px] tracking-[.12em] uppercase text-[var(--muted)] mt-1"><?php echo e($stat4Label); ?></div>
        </div>
      </div>
    </div>
  </div>
...
<?php /**PATH C:\Users\akm96\Downloads\New folder (5)\aurum\resources\views/components/hero.blade.php ENDPATH**/ ?>